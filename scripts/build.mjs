...
function prepare(html, meta) {
  ...
  const socialAlt = meta.socialAlt || 'Reac Studio: web, marketing y automatización';
  append(head, `<title>${e(meta.title)}</title><meta name="description" content="${e(meta.description)}"><meta name="author" content="Reac Studio"><meta name="robots" content="${robots}"><meta name="theme-color" content="#070712"><link rel="canonical" href="${e(url(meta.path))}"><link rel="icon" type="image/png" sizes="512x512" href="/icon.png"><link rel="shortcut icon" href="/favicon.ico"><link rel="apple-touch-icon" type="image/png" sizes="512x512" href="/apple-touch-icon.png"><meta property="og:type" content="${meta.article ? 'article' : 'website'}"><meta property="og:locale" content="es_AR"><meta property="og:site_name" content="Reac Studio"><meta property="og:title" content="${e(socialTitle)}"><meta property="og:description" content="${e(socialDescription)}"><meta property="og:url" content="${e(url(meta.path))}"><meta property="og:image" content="${e(url('/og-image.png'))}"><meta property="og:image:type" content="image/png"><meta property="og:image:width" content="1200"><meta property="og:image:height" content="630"><meta property="og:image:alt" content="${e(socialAlt)}"><meta name="twitter:card" content="summary_large_image"><meta name="twitter:title" content="${e(socialTitle)}"><meta name="twitter:description" content="${e(socialDescription)}"><meta name="twitter:image" content="${e(url('/og-image.png'))}"><meta name="twitter:image:alt" content="${e(socialAlt)}">`);
...
const mainMeta = {
  ...
  socialTitle:'Reac Studio | Desarrollo Web y Marketing Digital',
  socialDescription:'Creamos sitios web modernos, rápidos y estrategias digitales que impulsan tu negocio.',
  socialAlt:'Reac Studio — Desarrollo Web y Marketing Digital'
};
...
copyFileSync(resolve(root,'node_modules/gsap/dist/gsap.min.js'),resolve(output,'gsap.min.js'));
